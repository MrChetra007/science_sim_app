    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (isLocked)
            _buildLockedOverlay(context, provider, 'Reactive (RLC) Lab'),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text(
              'This expert lab is available in the Scientific Pro tier. You can also unlock it temporarily by watching a short ad.',
